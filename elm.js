...
var $author$project$Main$RecieveMessage = function (a) {
	return {$: 'RecieveMessage', a: a};
};
...
var $author$project$FFI$bridgeSub = _Platform_incomingPort('bridgeSub', $elm$json$Json$Decode$value);
var $author$project$Bridge$Hello = {$: 'Hello'};
...
var $author$project$Bridge$jsonDecSub = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return $elm$json$Json$Decode$succeed($author$project$Bridge$Hello);
	});
var $author$project$FFI$getBridge = F2(
	function (err, f) {
		return $author$project$FFI$bridgeSub(
			A2(
				$elm$core$Basics$composeR,
				$elm$json$Json$Decode$decodeValue($author$project$Bridge$jsonDecSub),
				function (res) {
					if (res.$ === 'Ok') {
						var a = res.a;
						return f(a);
...
var $author$project$FFI$bridgeCmd = _Platform_outgoingPort('bridgeCmd', $elm$core$Basics$identity);
var $author$project$Bridge$jsonEncCmd_Login = function (val) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Bridge$jsonEncCmd = function (_v0) {
	var v1 = _v0.a;
	return $author$project$Bridge$jsonEncCmd_Login(v1);
};
var $author$project$FFI$sendBridge = function (cmd) {
	return $author$project$FFI$bridgeCmd(
		$author$project$Bridge$jsonEncCmd(cmd));
};
			...
			case 'RecieveMessage':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							messages: A2($elm$core$List$cons, x, model.messages)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Error':
				var err = msg.a;
...
var $author$project$Utils$maybeList = F2(
	function (m, f) {
		if (m.$ === 'Just') {
			var a = m.a;
			return _List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_Utils_ap(
			A2(
				$author$project$Utils$maybeList,
				model.error,
				A2(
					$elm$core$Basics$composeR,
					$elm$html$Html$text,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Attributes$value(model.server),
							$elm$html$Html$Events$onInput($author$project$Main$UpdateServer)
						]),
					_List_Nil),
					A2(
					$elm$html$Html$button,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		subscriptions: function (_v1) {
			return A2(
				$author$project$FFI$getBridge,
				$author$project$Main$Error,
				$elm$core$Basics$always(
					$author$project$Main$RecieveMessage('Got it!')));
		},
